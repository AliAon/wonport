  ...
  const router=useRouter()
    ...
    return (
        <Fragment>
            ...
            <button type="button"
      onClick={()=>router.push('/dashboard/product/add-products')}
      style={{
        marginBottom:'10px'
      }} className={`ti-btn ti-btn-primary-full ti-btn-wave`} key={Math.random()}>Add Product</button>
                                            ...
                                            <tr className="product-list" key={Math.random()}>
                                                ...
                                                <td>
                                                    <div className="flex flex-row items-center !gap-2 text-[0.9375rem]">
                                                        <Link aria-label="anchor" href="/dashboard/product/edit-products/"
