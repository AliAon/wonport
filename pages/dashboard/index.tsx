    ...
    <Fragment>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-4">
          <div className="box h-[95%] crm-highlight-card">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <span className="block font-semibold mt-[0.125rem]">
                    <Link className="text-white text-[0.813rem]" href="#!">
                      <u>Click here</u>
                    </Link>
                  </span>
                </div>
        ...
        <div className="col-span-8 grid gap-x-4 grid-cols-12">
        ...
        <div className="xxl:col-span-6 col-span-12">
          <div className="grid grid-cols-12 gap-x-6">
            ...
            <div className="box custom-box">
                    ...
                    {Countries.map((idx,index) => {
                        if(index>0) return
                      return(<li className={idx.class2} key={Math.random()}>
