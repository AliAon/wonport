...
const Orders = () => {
    return (
        <Fragment>
            <Seo title={"Orders"} />
            <Pageheader currentpage="Orders" activepage="Dashboard" mainpage="Orders" />
                    ...
                    <div className="box">
                        <div className="box-header block !justify-start">
                            <div className="sm:flex block items-center w-full">
                                ...
                                <div className="flex-grow">
                                    <Link href="/dashboard/orders/denim-zep-co-sweat-shirt">
                    ...
                    <div className="box">
                        <div className="box-header block !justify-start">
                            <div className="sm:flex block items-center w-full ">
                                ...
                                <div className="flex-grow">
                                <Link href="/dashboard/orders/jimmy-lolfiger-jacket">
                    ...
                    <div className="box">
                        <div className="box-header block !justify-start">
                            <div className="sm:flex block items-center w-full ">
                                ...
                                <div className="flex-grow">
                                <Link href="/dashboard/orders/louie-phillippe-coat">
                    ...
                    <div className="box">
                        <div className="box-header !justify-start block">
                            <div className="sm:flex block items-center w-full ">
                                ...
                                <div className="flex-grow">
                                <Link href="/dashboard/orders/denim-corp">
                    ...
                    <div className="box">
                        <div className="box-header !justify-start block">
                            <div className="sm:flex block items-center w-full ">
                                ...
                                <div className="flex-grow">
                                <Link href="/dashboard/orders/pufa-sweat-shirt">
                    ...
                    <div className="box">
                        <div className="box-header !justify-start block">
                            <div className="sm:flex block items-center w-full ">
                                ...
                                <div className="flex-grow">
                                <Link href="/dashboard/orders/bluberry-co-in">
