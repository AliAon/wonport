...
const ProductIcon = <i className="bx bx-cart side-menu__icon"></i>;

const OrderIcon = <i className="bx bx-cart side-menu__icon"></i>;

const ProfileIcon = <i className="bx bx-user side-menu__icon"></i>;

const BellIcon = <i className="bx bx-bell side-menu__icon"></i>;

const PaymentIcon = <i className="bx bxl-paypal side-menu__icon"></i>;

const TruckIcon = <i className="bx bxs-truck side-menu__icon"></i>;
