    ...
    <>
      <div className="e-table">
              ...
              {page.map((row: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td>
                    <div className='hstack gap-2 flex-wrap'><Link aria-label='anchor' href='/dashboard/product/edit-products' className='text-info text-[.875rem] leading-none'> <i className='ri-edit-line'></i></Link><Link className="hs-dropdown-toggle text-danger text-[.875rem] leading-none" data-hs-overlay="#exampleModalScrollable" aria-label='anchor' href='#' > <i className='ri-delete-bin-5-line'></i> </Link> </div>
        ...
        <div id="exampleModalScrollable" className="hs-overlay hidden ti-modal">
              <div className="hs-overlay-open:mt-10  ti-modal-box mt-0 ease-out">
                <div className="ti-modal-content">
               
                  <div className="ti-modal-body px-4">
                  <h3 className="!text-defaulttextcolor py-5 dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold text-center">Are You Sure</h3>
              
                  </div>
                  <div className="ti-modal-footer justify-center">
                    <button type="button"
                      className="hs-dropdown-toggle ti-btn  ti-btn-secondary-full align-middle"
                      data-hs-overlay="#exampleModalScrollable">
                      No
                    </button>
                    <button type="button" className="ti-btn bg-primary text-white !font-medium">Delete</button>
                  </div>
                </div>
              </div>
            </div>
